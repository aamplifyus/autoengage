...
from autoengage.base import SCHOOL_SOCIAL_URLS, timed
...
if __name__ == '__main__':
    ...
    socials = collections.defaultdict(list)
    ...
    for school, urls in SCHOOL_SOCIAL_URLS.items():
        ...
        _urls.extend(urls)
        # if school in ['Washington hs']:
        #     crawler.crawl(urls[0], MAX_URLS, verbose)
        #     # get results
    ...
    # store in dictionary
    # emails[school][url] = email_list
    # phones[school][url] = phone_list
    # socials[school].extend(social_handles)
